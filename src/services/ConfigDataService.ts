  ...
  get defaultConfig(): Config {
    return {
      ...
      emojis: {
        ...
        GLOBAL: Object.fromEntries(Object.entries(EMOJI.global).map(([k, v]) => [k, v])) as any,
        CATEGORY: Object.fromEntries(Object.entries(EMOJI.category).map(([k, v]) => [k, v])) as any,
        USER: Object.fromEntries(Object.entries(EMOJI.user).map(([k, v]) => [k, v])) as any,
      },
    }
  }
}
