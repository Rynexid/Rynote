...
export default class implements Command {
  ...
  private async prefixMode(
    ...
    if (value == null)
      return message.reply({
        flags: 32768,
        components: buildV2({
          description: `${client.i18n.get(language, 'command.playlist', 'edit_arg')}`,
          color: client.color,
        }),
      } as any)
    ...
    if (!playlist)
      return message.reply({
        flags: 32768,
        components: buildV2({
          description: `${client.i18n.get(language, 'command.playlist', 'edit_notfound')}`,
          color: client.color,
        }),
      } as any)
    if (playlist.owner !== message.author.id)
      return message.reply({
        flags: 32768,
        components: buildV2({
          description: `${client.i18n.get(language, 'command.playlist', 'edit_playlist_owner')}`,
          color: client.color,
        }),
      } as any)
    ...
    for (let i = 0; i < questions.length; i++) {
      ...
      if (count == questions.length) {
        ...
        if (newId) {
          if (!this.vaildId(newId)) {
            message.reply({
              flags: 32768,
              components: buildV2({
                description: `${client.i18n.get(language, 'command.playlist', 'edit_invalid_id')}`,
                color: client.color,
              }),
            } as any)
          ...
          if (isAlreadyId)
            return message.reply({
              flags: 32768,
              components: buildV2({
                description: `${client.i18n.get(language, 'command.playlist', 'ineraction_edit_invalid_id')}`,
                color: client.color,
              }),
            } as any)
          ...
          if (this.validMode(String(newMode)) == null) {
            message.reply({
              flags: 32768,
              components: buildV2({
                description: `${client.i18n.get(language, 'command.playlist', 'edit_invalid_mode')}`,
                color: client.color,
              }),
            } as any)
          ...
          await message.reply({
            flags: 32768,
            components: buildV2({
              description: `${client.i18n.get(language, 'command.playlist', 'edit_success', {
                playlistId: newId,
              })}`,
              color: client.color,
            }),
        ...
        message.reply({ flags: 32768, components: embed } as any)
  ...
  private async interactionMode(
    ...
    const modal = new ModalBuilder()
      ...
      .setTitle(`${client.i18n.get(language, 'command.playlist', 'editor_title')}`)
      .setComponents(
    ...
    if (!playlist)
      return interaction.reply({
        flags: 32768,
        components: buildV2({
          description: `${client.i18n.get(language, 'command.playlist', 'ineraction_edit_notfound')}`,
          color: client.color,
        }),
      } as any)
    ...
    if (playlist.owner !== interaction.user.id)
      return interaction.reply({
        flags: 32768,
        components: buildV2({
          description: `${client.i18n.get(language, 'command.playlist', 'ineraction_edit_playlist_owner')}`,
          color: client.color,
        }),
      } as any)
    ...
    if (!collector)
      return interaction.editReply({
        flags: 32768,
        components: buildV2({
          description: `${client.i18n.get(language, 'command.playlist', 'ineraction_edit_playlist_error')}`,
          color: client.color,
        }),
      } as any)
    ...
    if (newId) {
      ...
      await collector.editReply({
        flags: 32768,
        components: buildV2({
          description: `${client.i18n.get(language, 'command.playlist', 'ineraction_edit_success', {
            playlistId: newId,
          })}`,
          color: client.color,
        }),
